...
!function (e, t) {
  ...
  !function (G) {
    ...
    "classList" in document.createElement("_") || function (e) {
      if ("Element" in e) {
        var t = "classList", i = "prototype", n = e.Element[i], s = Object, o = function () {
          var i = G(this);
          return {
            add: function (e) {
              return i.addClass(e)
    ...
    function S(e) {
      ...
      if (e.multiple) for (var s = 0, o = n.length; s < o; s++) (t = n[s]).selected && i.push(t.value || t.text); else i = e.value;
      return i
    }
    ...
    var s = {useDefault: !1, _set: G.valHooks.select.set};
    ...
    var h = function (t) {
      ...
      v = h({"&amp;": "&", "&lt;": "<", "&gt;": ">", "&quot;": '"', "&#x27;": "'", "&#x60;": "`"}), E = {
        ...
        104: "8",
        105: "9"
      }, C = 27, O = 13, T = 32, H = 9, D = 38, L = 40, K = {success: !1, major: "3"};
    try {
    ...
    var P = new RegExp(D + "|" + L), R = new RegExp("^" + H + "$|" + C), u = function (e, t) {
      var i = this;
    ...
    u.VERSION = "1.13.5", u.BootstrapVersion = K.major, u.DEFAULTS = {
      ...
      constructor: u, init: function () {
        ...
        var e, t = this.multiple || this.options.showTick ? " show-tick" : "", i = this.autofocus ? " autofocus" : "",
          n = "", s = "", o = "", l = "";
        ...
        function i(e, t) {
          var i, n, s, o, l, r, a, c, d, h, p = O.selectpicker.current.elements.length, u = [], f = !0,
            m = O.isVirtual();
          ...
          if (void 0 === l && (l = 0), r = [O.selectpicker.view.position0, O.selectpicker.view.position1], s = Math.max(0, l - 1), o = Math.min(n - 1, l + 1), O.selectpicker.view.position0 = Math.max(0, u[s][0]) || 0, O.selectpicker.view.position1 = Math.min(p, u[o][1]) || 0, a = r[0] !== O.selectpicker.view.position0 || r[1] !== O.selectpicker.view.position1, void 0 !== O.activeIndex && (T = O.selectpicker.current.elements[O.selectpicker.current.map.newIndex[O.prevActiveIndex]], H = O.selectpicker.current.elements[O.selectpicker.current.map.newIndex[O.activeIndex]], z = O.selectpicker.current.elements[O.selectpicker.current.map.newIndex[O.selectedIndex]], t && (O.activeIndex !== O.selectedIndex && (H.classList.remove("active"), H.firstChild && H.firstChild.classList.remove("active")), O.activeIndex = void 0), O.activeIndex && O.activeIndex !== O.selectedIndex && z && z.length && (z.classList.remove("active"), z.firstChild && z.firstChild.classList.remove("active"))), void 0 !== O.prevActiveIndex && O.prevActiveIndex !== O.activeIndex && O.prevActiveIndex !== O.selectedIndex && T && T.length && (T.classList.remove("active"), T.firstChild && T.firstChild.classList.remove("active")), (t || a) && (c = O.selectpicker.view.visibleElements ? O.selectpicker.view.visibleElements.slice() : [], O.selectpicker.view.visibleElements = O.selectpicker.current.elements.slice(O.selectpicker.view.position0, O.selectpicker.view.position1), O.setOptionStatus(), (C || !1 === m && t) && (d = c, h = O.selectpicker.view.visibleElements, f = !(d.length === h.length && d.every(function (e, t) {
            ...
            var b, w, I = O.$menuInner[0], x = document.createDocumentFragment(), k = I.firstChild.cloneNode(!1),
        ...
        if (this.options.title && !this.multiple) {
          B--;
          var t = this.$element[0], i = !1, n = !this.selectpicker.view.titleOption.parentNode;
        ...
        F.each(function (e) {
          ...
          if (B++, !t.hasClass("bs-title-option")) {
            var i, n, s, o, l = t.data(), r = this.className || "", a = q(this.style.cssText), c = l.content,
              d = this.textContent, h = l.tokens, p = l.subtext, u = l.icon, f = t.parent(), m = f[0],
              v = "OPTGROUP" === m.tagName, g = v && m.disabled, b = this.disabled || g,
              w = this.previousElementSibling && "OPTGROUP" === this.previousElementSibling.tagName, I = f.data();
            ...
            if (v && !0 !== l.divider) {
              ...
              var k = " " + m.className || "", $ = this.previousElementSibling;
              if (void 0 !== (i = l.prevHiddenIndex) && ($ = F[i].previousElementSibling), !$) {
                R += 1;
                var E = m.label, S = q(E), y = I.subtext, C = I.icon;
        ...
        var e = this, t = this.$element.find("option"), i = [], n = [];
        this.togglePlaceholder(), this.tabIndex();
        for (var s = 0, o = t.length; s < o; s++) {
          var l = e.selectpicker.main.map.newIndex[s], r = t[s],
        ...
        if (e || !1 !== this.options.size && !this.sizeInfo) {
          ...
          var t = document.createElement("div"), i = document.createElement("div"), n = document.createElement("div"),
            s = document.createElement("ul"), o = document.createElement("li"), l = document.createElement("li"),
            r = document.createElement("li"), a = document.createElement("a"), c = document.createElement("span"),
          ...
          var v, g = a.offsetHeight, b = l ? l.offsetHeight : 0, w = d ? d.offsetHeight : 0, I = h ? h.offsetHeight : 0,
            x = p ? p.offsetHeight : 0, k = u ? u.offsetHeight : 0, $ = G(o).outerHeight(!0),
            E = !!window.getComputedStyle && window.getComputedStyle(i), S = i.offsetWidth, y = E ? null : G(i), C = {
        ...
        var t, i, n, s, o, l, r, a = this.sizeInfo.selectWidth, c = this.sizeInfo.liHeight,
          d = this.sizeInfo.headerHeight, h = this.sizeInfo.searchHeight, p = this.sizeInfo.actionsHeight,
          u = this.sizeInfo.doneButtonHeight, f = this.sizeInfo.dividerHeight, m = this.sizeInfo.menuPadding, v = 0;
        ...
        if (e.noScroll = !1, e.selectpicker.view.visibleElements && e.selectpicker.view.visibleElements.length) for (var i = 0; i < e.selectpicker.view.visibleElements.length; i++) {
          var n = e.selectpicker.current.map.originalIndex[i + e.selectpicker.view.position0], s = t[n];
          if (s) {
            var o = this.selectpicker.main.map.newIndex[n], l = this.selectpicker.main.elements[o];
        ...
        t.data("spaceSelect", !1), this.$button.on("keyup", function (e) {
          ...
          var i = G(this), n = E.isVirtual() ? E.selectpicker.view.position0 : 0,
            s = E.selectpicker.current.map.originalIndex[i.parent().index() + n], o = S(E.$element[0]),
          ...
          if (E.multiple && 1 !== E.options.maxOptions && e.stopPropagation(), e.preventDefault(), !E.isDisabled() && !i.parent().hasClass(Y.DISABLED)) {
            var a = E.$element.find("option"), c = a.eq(s), d = c.prop("selected"), h = c.parent("optgroup"),
              p = h.find("option"), u = E.options.maxOptions, f = h.data("maxOptions") || !1;
            if (s === E.activeIndex && (t = !0), t || (E.prevActiveIndex = E.activeIndex, E.activeIndex = void 0), E.multiple) {
              if (c.prop("selected", !d), E.setSelected(s, !d), i.blur(), !1 !== u || !1 !== f) {
                var m = u < a.filter(":selected").length, v = f < h.find("option:selected").length;
                if (u && m || f && v) if (u && 1 == u) {
                  ...
                  var w = "string" == typeof E.options.maxOptionsText ? [E.options.maxOptionsText, E.options.maxOptionsText] : E.options.maxOptionsText,
                    I = "function" == typeof w ? w(u, f) : w, x = I[0].replace("{n}", u), k = I[1].replace("{n}", f),
        ...
        this.$button.on("click.bs.dropdown.data-api", function () {
          ...
          if (u.selectpicker.search.map.newIndex = {}, u.selectpicker.search.map.originalIndex = {}, u.selectpicker.search.elements = [], u.selectpicker.search.data = [], e) {
            var t = [], i = e.toUpperCase(), n = {}, s = [], o = u._searchStyle(), l = u.options.liveSearchNormalize;
            ...
            for (var c = s.length; r < c; r++) {
              var d = s[r], h = s[r - 1], p = (a = u.selectpicker.main.data[d], u.selectpicker.main.data[h]);
        ...
        if (this.multiple) {
          void 0 === e && (e = !0);
          var t = this.$element.find("option"), i = 0, n = 0, s = S(this.$element[0]);
          this.$element.addClass("bs-select-hidden");
          for (var o = 0; o < this.selectpicker.current.elements.length; o++) {
            var l = this.selectpicker.current.data[o], r = t[this.selectpicker.current.map.originalIndex[o]];
        ...
        var t, i, n, s, o, l = G(this), r = l.hasClass("dropdown-toggle"),
          a = (r ? l.closest(".dropdown") : l.closest(N.MENU)).data("this"), c = a.findLis(), d = !1,
          h = e.which === H && !r && !a.options.selectOnTab, p = P.test(e.which) || h, u = a.$menuInner[0].scrollTop,
          f = a.isVirtual(), m = !0 === f ? a.selectpicker.view.position0 : 0;
